...
urlpatterns = [
    ...
    path('predictions_brain_tumor/', BrainTumorPredictionViewSet.as_view({'get': 'list', 'post': 'create'}), name='predictions_brain_tumor'),
    path('predictions_diabetes/', DiabetesPredictionViewSet.as_view({'get': 'list', 'post': 'create'}), name='predictions_diabetes'),
]
